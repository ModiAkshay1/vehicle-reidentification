...
def get_data(name, data_dir, height, width, batch_size, workers, path_query, path_gallery, class_query):
    root = osp.join(data_dir, name)

    dataset = datasets.create(name, root, path_query, path_gallery, class_query)
...
def main_worker(args):
    ...
    dataset, test_loader = get_data(args.dataset, args.data_dir, args.height,
                                    args.width, args.batch_size, args.workers,args.path_query, args.path_gallery, args.class_query)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_query',type=str,required=True)
    parser.add_argument('--path_gallery',type=str,required=True)

    parser.add_argument('--class_query', type=str, required=True)
    parser.add_argument('--class_save_path', type=str, required=True)
